...
class LB_PDF extends FPDF
{
    ...
    public function Header()
    {
        if ($this->pageHeaderRepeat || (!$this->pageHeaderRepeat && !$this->pageHeaderAdded)) {
            ...
            // Title
            $this->Cell(0, 7, 'POLYTECHNIC UNIVERSITY OF THE PHILIPPINES', 0, 0, 'C');
            $this->Ln();
            $this->SetFont('Times', '', 14);
            $this->SetTextColor(0, 0, 0);
            $this->Cell(0, 7, 'TAGUIG BRANCH', 0, 0, 'C');
            $this->Ln();
            $this->Cell(0, 7, 'General Santos Avenue, Bicutan Taguig City', 0, 0, 'C');
            $this->Ln();
            $this->SetFont('Times', '', 14);
            $this->Ln(15);
            ...
            if ($this->fromDate != '' || $this->toDate != '') {
                if ($this->fromDate != '' && $this->toDate != '') {
                    $this->Cell(0, 8, 'From ' . $this->fromDate . '  to  ' . $this->toDate, 0, 0, 'C');
                } else if ($this->fromDate != '') {
                    $this->Cell(0, 7,  $this->fromDate, 0, 0, 'C');
                }
            }
            // Line break.
            $this->Ln(2);    //height of break can be given
