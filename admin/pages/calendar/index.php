    ...
    <script>
        $(function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                locale: 'es', // Configuración local en español
                headerToolbar: {
                    left: 'prev,next today',
                    center: 'title',
                    right: 'dayGridMonth,timeGridWeek,timeGridDay,listMonth'
                },
                eventBackgroundColor: '#007bff', // Cambiar color de fondo de los eventos
                eventBorderColor: '#007bff', // Cambiar color del borde de los eventos
                eventTextColor: '#000000', // Cambiar color del texto de los eventos
            ...
            var currColor = '#007bff' // Azul por defecto
            // Selector de color
            ...
            $('#add-new-event').click(function(e) {
                e.preventDefault()
                // Obtener valor y asegurarse de que no sea nulo
