                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT CONCAT(p.fname,' ',p.lname) as pname,n.id,n.subject,n.created_at FROM notification n INNER JOIN tblpatient p ON n.patient_id = p.id WHERE n.type='0' AND n.doc_id = '$userid'";
...
<script>
    $(document).ready(function () {
        ...
        'aaSorting': [[1, 'DESC']], // start to sort data in second column
        'searching': false,
        'responsive':true,
        });
